USE [msdb]
GO
PRINT 'SCRIPT PARA MIGRAÇAÕ DOS JOBS DO MCN14.MULTICOMNET.LOCAL PARA O SERVIDOR MCN17.MULTICOMNET.LOCAL'
...
BEGIN /*JOBS DE MANUTENÇÃO - DEVEM ESTAR EM UM ARQUIVO A PARTE */
